...
function Allproduct(){
    ...
    <section class="bg-gray-50 dark:bg-gray-900 p-3 sm:p-5 antialiased">
        ...
        <div className=" text-5xl font-bold text-gray-900 dark:text-white my-6">
                All Product List
                {msg && <p className=" text-xl text-center text-success text-red-600 mt-4">{msg}</p>}
                </div>
                ...
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    ...
                    <tbody>
                        ...
                        <tr class="border-b dark:border-gray-700">
                            <th scope="row" class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">{num + 1}</th>
                            <th scope="row" class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">{p.productName}</th>
                            <td class="px-4 py-3">{p.productDescription}</td>
                            <td class="px-4 py-3 max-w-[12rem] truncate">{p.productBrand }</td>
                            ...
                            <button class="relative inline-flex items-center justify-center p-0.5 mb-2 me-2 overflow-hidden text-sm font-medium text-gray-900 rounded-lg group bg-gradient-to-br from-red-500 to-red-700 group-hover:from-pink-500 group-hover:to-red-400 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-pink-200 dark:focus:ring-pink-800" onClick={()=>deleteProduct(p.id)}>
                                <span class="relative px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 rounded-md group-hover:bg-opacity-0">
                                Delete
                                </span>
                            </button>
